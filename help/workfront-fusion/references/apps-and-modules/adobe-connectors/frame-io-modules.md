...
description: '[!DNL Adobe Workfront Fusion Frame].io モジュールを使用すると、[!DNL Frame.io] アカウントのアセットとコメントを監視、作成、更新、取得、または削除できます。'
author: Becky
...
API トークンを使用して[!DNL Frame.io] アカウントをWorkfront Fusionに接続するには、[!DNL Frame.io] アカウントにAPI トークンを作成し、Workfront Fusion [!DNL Frame.io] [!UICONTROL 接続を作成] ダイアログに挿入する必要があります。
...
1. 提供されたトークンをコピーします。
1. Workfront Fusionに移動し、[!DNL Frame.io] モジュールの&#x200B;**[!UICONTROL 接続を作成]** ダイアログを開きます。
1. 「**[!UICONTROL 接続タイプ]**」フィールドで「**[!DNL Frame.io]**」を選択します。
1. 手順5でコピーしたトークンを&#x200B;**[!UICONTROL 自分の[!DNL Frame.io] API キー]** フィールドに入力します
...
1. [!DNL Frame.io] で OAuth 2.0 アプリを作成します。 手順については、[!DNL Frame.io] ドキュメントの [!UICONTROL OAuth 2.0 コード承認フロー] を参照してください。
   ...
   >   
   >     * **アメリカ / アジア太平洋**: `https://app.workfrontfusion.com/oauth/cb/frame-io5`
   >
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Asset ID] </td> 
   <td> <p>更新するアセットのIDを入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Name] </td> 
...
このトリガーモジュールは、指定したチームに属するアセットが削除されたときにシナリオを開始します。

これはインスタントトリガーなので、使用するWebhookを選択または作成する必要があります。

Webhookを追加する場合は、次の情報を入力します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p> Webhookの名前（「アセットが削除されました」など）を入力します。</p> </td> 
  </tr> 
  <tr> 
    <td role="rowheader">[!UICONTROL Connection] </td> 
   <td>[!DNL Frame.io] への接続を作成する手順について詳しくは、この記事の<a href="#connect-frameio-to-adobe-workfront-fusion" class="MCXref xref"> [!DNL Frame.io] を Adobe Workfront Fusion に接続</a>を参照してください。</td> 
...
このトリガーモジュールは、指定したチームセットが所有するアセットのラベルが、変更または削除された場合にシナリオを開始します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL Webhook name]</td> 
   <td> <p> 「アセットステータスが更新されました」など、Webhookの名前を入力します。</p> </td> 
  </tr> 
  <tr> 
    <td role="rowheader">[!UICONTROL Connection] </td> 
   <td>[!DNL Frame.io] への接続を作成する手順について詳しくは、この記事の<a href="#connect-frameio-to-adobe-workfront-fusion" class="MCXref xref"> [!DNL Frame.io] を Adobe Workfront Fusion に接続</a>を参照してください。</td> 
...
このトリガーモジュールは、指定したチーム用に新しいアセットが作成されたときにシナリオを開始します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL Webhook name]</td> 
   <td> <p> 「Asset created」など、Webhookの名前を入力します。</p> </td> 
  </tr> 
  <tr> 
    <td role="rowheader">[!UICONTROL Connection] </td> 
   <td>[!DNL Frame.io] への接続を作成する手順について詳しくは、この記事の<a href="#connect-frameio-to-adobe-workfront-fusion" class="MCXref xref"> [!DNL Frame.io] を Adobe Workfront Fusion に接続</a>を参照してください。</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Asset ID] </td> 
   <td> <p>削除するコメントを含むアセットのIDを入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Comment ID] </td> 
