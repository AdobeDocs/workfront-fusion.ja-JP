...
description: '[!DNL Adobe Workfront Fusion Adobe Creative Cloud] ライブラリモジュールを使用すると、要素またはライブラリが作成または更新されたときにシナリオを開始できます。 また、要素をアップロード、取得、アーカイブまたはリストすることも、[!DNL Adobe Creative Cloud Libraries] API を呼び出すこともできます。'
author: Becky
...
>[!IMPORTANT]
>
>接続の作成は現在、Creative Cloud Libraries コネクタでは使用できません。 既存の接続は期待どおりに機能します。
...
## Adobe Creative Cloud Libraries APIについて

Adobe Creative Cloud ライブラリコネクタでは、次の機能を使用します。
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    <tr>
      ...
      <td>既存のCreative Cloud Libraries接続を選択します。 接続の作成は現在、Creative Cloud Libraries コネクタでは使用できません。 既存の接続は期待どおりに機能します。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>アーカイブする要素を選択するか、マッピングします。</td>
    </tr>
  </tbody>
</table>
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      <td role="rowheader">[!UICONTROL Library ID]</td>
      <td >エレメントのリスト元となるライブラリを選択またはマッピングします。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td >MIME タイプを入力またはマッピングして、指定したMIME タイプで識別される要素に結果を制限します。 例：<code>string</code>。</td>
    </tr>
    <tr>
      <td role="rowheader">[!UICONTROL Selector]</td>
      <td>
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      <td role="rowheader">[!UICONTROL Library ID]</td>
      <td >アセットをアップロードするライブラリを選択します。</td>
    </tr>
    <tr>
    ...
    <tr>
      <td role="rowheader">[!UICONTROL ファイル形式]</td>
