...
このアクションモジュールは、[!DNL Marketo] API に対して認証済みのカスタム呼び出しを実行します。 これにより、他の [!DNL Marketo] モジュールでは不可能なデータフロー自動処理を作成できます。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>https://{your-base-url}.mktorest.com/</code> からの相対パスを入力します。</td> 
  </tr> 
  <tr> 
