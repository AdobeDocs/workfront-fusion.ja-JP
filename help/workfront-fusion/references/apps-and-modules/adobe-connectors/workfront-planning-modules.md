...
description: '[!DNL Adobe Workfront Planning] モジュールを使用すると、[!DNL Adobe] Workfront Planning アカウント内のイベントに基づいてAdobe Workfront Fusion シナリオを開始し、契約書およびその他のレコードを作成、読み取りまたは更新し、設定した条件を使用してレコードを検索し、ドキュメントをアップロードできます。'
author: Becky
