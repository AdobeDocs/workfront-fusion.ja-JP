...
description: Adobe Workfront Fusionでは、Markdown モジュールを使用してMarkdownをHTMLに、HTMLをMarkdownに変換できます。
author: Becky
...
Adobe Workfront Fusion シナリオでは、[!UICONTROL Markdown] モジュールを使用して、MarkdownをHTMLに、HTMLをMarkdownに変換できます。
