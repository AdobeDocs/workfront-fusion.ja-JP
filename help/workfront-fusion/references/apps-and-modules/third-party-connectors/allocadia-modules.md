...
description: Adobe Workfront Fusionでは、Allocadiaを使用するワークフローを自動化したり、複数のサードパーティアプリケーションやサービスに接続したりできます。
author: Becky
...
Adobe Workfront Fusion のシナリオでは、[!DNL Allocadia] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
<table style="table-layout:auto"> <table style="table-layout:auto"> <col> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Allocadia アカウントをWorkfront Fusionに接続する方法については、この記事の「<a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">[!UICONTROL Connect Allocadia] to Workfront Fusion</a>」を参照してください。</p> </td> 
  </tr> 
  <tr> 
...
このアクションモジュールは、[!DNL Allocadia] API に対して認証済みのカスタム呼び出しを実行します。 これにより、他の [!DNL Allocadia] モジュールでは不可能なデータフロー自動処理を作成できます。
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Connection]</p> </td> 
   <td> <p>[!DNL Allocadia] アカウントを Workfront Fusion に接続する手順について詳しくは、この記事の <a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">[!DNL Allocadia] を Workfront Fusion に接続</a>を参照してください。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>このモジュールで読み取るレコードの一意の [!DNL Allocadia] ID を入力またはマッピングします。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Connection]</p> </td> 
   <td> <p>[!UICONTROL Allocadia] アカウントをWorkfront Fusionに接続する方法については、この記事の「<a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">Workfront Fusionに[!DNL Allocadia]を接続</a>」を参照してください。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Entity Type]</td> 
...
この検索モジュールは、指定した検索クエリに一致する [!DNL Allocadia] 内のオブジェクトのレコードを検索します。
