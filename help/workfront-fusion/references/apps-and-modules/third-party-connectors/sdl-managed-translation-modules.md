...
description: Adobe Workfront Fusionでは、SDL Managed Translation アカウントを複数のサードパーティ製アプリケーションやサービスに接続できます。
author: Becky
...
Adobe Workfront Fusion シナリオでは、[!DNL SDL Managed Translation] アカウントを複数のサードパーティ製アプリケーションやサービスに接続できます。
...
## SDL Managed Translation API情報

SDL Managed Translation コネクタでは、次の機能が使用されます。
