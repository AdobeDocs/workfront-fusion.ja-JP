...
Adobe Workfront Fusion のシナリオでは、[!DNL Microsoft OneDrive for Business] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
Adobe Workfront Fusionで[!DNL Microsoft OneDrive for Business]を使用するには、[!DNL Microsoft] アカウントが必要です。

## Workfront Fusionへの[!DNL Microsoft OneDrive for Business] サービスの接続
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 監視するフォルダーを選択します。 1 つのシナリオでは、監視できるフォルダーは 1 つだけです。</p> <p>ヒント：複数のフォルダーを監視するには、それぞれのフォルダーに対して独立したシナリオを作成します。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 1つのサイクル中にモジュールが返す結果の最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
