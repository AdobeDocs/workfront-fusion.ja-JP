...
1. 個人用アクセストークンと OAuth 2 認証のどちらを使用するかを選択します。
1. 接続に名前を入力します。
1. （条件付き）個人用アクセストークンを使用している場合は、「詳細設定を表示」をクリックし、個人用アクセストークンを入力します。
1. （条件付き） OAuth 2 を使用している場合は、「詳細設定を表示」をクリックし、エアテーブルクライアント ID およびクライアントシークレットを入力します。
