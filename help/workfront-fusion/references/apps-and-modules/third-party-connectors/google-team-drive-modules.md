...
description: '[!DNL Adobe Workfront Fusion Google Team Drive] モジュールを使用すると、ファイルの監視、アップロード、更新、コピー、削除、取得、および[!DNL Google Shared] ドライブ内のフォルダーの作成を行うことができます。'
author: Becky
...
Adobe Workfront Fusion [!DNL Google Team Drive] モジュールを使用すると、ファイルの監視、アップロード、更新、コピー、削除、取得、および[!DNL Google Shared Drive]内のフォルダーの作成を行うことができます。

Adobe Workfront Fusionで[!DNL Google Team Drive]を使用するには、[!DNL Google Workspace] アカウントが必要です。 アカウントをお持ちでない場合は、[[!DNL Google Workspace] 新規登録サイト](https://workspace.google.com/business/signup/welcome)で [!DNL Google Workspace] アカウントを作成できます。

Adobe Workfront Fusion のシナリオでは、[!DNL Google Team Drive] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
**bold**&#x200B;に表示されるモジュールダイアログフィールド（Workfront Fusion シナリオでは、このドキュメント記事の&#x200B;**not**）は必須です。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Google Team Drive] アカウントをWorkfront Fusionに接続する手順については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobe Workfront Fusionへの接続の作成 – 基本手順</a>を参照してください。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 1回の実行サイクルでWorkfront Fusionが返すファイルの最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 1回の実行サイクルでWorkfront Fusionが返すファイルまたはフォルダーの最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
