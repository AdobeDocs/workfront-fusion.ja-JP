---
title: Cvent モジュール
description: Adobe Workfront Fusionでは、Cventを使用するワークフローを自動化したり、複数のサードパーティアプリケーションやサービスに接続したりできます。
author: Becky
...
Adobe Workfront Fusion のシナリオでは、[!DNL Cvent] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
## [!DNL Cvent]をAdobe Workfront Fusionに接続 {#connect-cvent-to-adobe-workfront-fusion}
...
>
>  Workfront FusionのIP アドレスの一覧については、組織の組織のFluidic許可リストでの[FusionのIP アドレスの設定](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/set-up-ip-addresses-for-fusion.md)を参照してください
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Cvent] アカウントをWorkfront Fusionに接続する方法については、この記事の「<a href="#connect-cvent-to-adobe-workfront-fusion" class="MCXref xref">Adobe Workfront Fusion</a>に[!DNL Cvent]を接続する」を参照してください。</p> </td> 
  </tr> 
  <tr> 
