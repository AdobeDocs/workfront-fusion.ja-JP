  ...
  <tr> 
   ...
   <td> <p>メールの監視に使用するフィルタータイプを選択</p> 
    <ul> 
     ...
     <li> <p> <strong>[!UICONTROL Gmail filter]</strong> </p> <p>「[!UICONTROL Query]」フィールドに、メールのフィルタリングに使用するクエリを入力します。</p> <p>[!DNL Gmail]個のフィルターについて詳しくは、[!DNL Gmail]のドキュメントの<a href="https://support.google.com/mail/answer/7190">検索の絞り込み</a>を参照してください。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td>[!UICONTROL Connection] </td> 
   <td> <p>[!DNL Gmail] アカウントをWorkfront Fusionに接続する手順については、この記事の「<a href="#connect-gmail-to-workfront-fusion" class="MCXref xref">Workfront Fusion</a>に[!DNL Gmail]を接続する」を参照してください。</p> </td> 
  </tr> 
  <tr> 
