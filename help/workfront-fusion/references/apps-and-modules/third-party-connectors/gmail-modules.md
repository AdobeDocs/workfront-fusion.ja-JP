---
title: Gmail モジュール
description: Adobe Workfront Fusionでは、Gmailを使用するワークフローを自動化したり、複数のサードパーティアプリケーションやサービスに接続したりできます。
author: Becky
...
Adobe Workfront Fusion のシナリオでは、[!DNL Gmail] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
* [&#x200B; [!DNL Gmail] を使用してWorkfront Fusionに [!DNL Google Workspace]接続する](#connect-gmail-to-workfront-fusion-usinggoogle-workspace)
* [&#x200B; [!DNL Gmail] または [!DNL gmail.com] .comを使用して [!DNL googlemail]Workfront Fusionに接続します](#connect-gmail-to-workfront-fusion-using-gmailcom-or-googlemailcom)

### [!DNL Gmail]を使用して[!DNL &#x200B; Google Workspace]をWorkfront Fusionに接続する
...
### [!DNL Gmail]または[!DNL gmail.com].comを使用して[!DNL googlemail]をWorkfront Fusionに接続します
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Gmail] アカウントをWorkfront Fusionに接続する手順については、この記事の「<a href="#connect-gmail-to-workfront-fusion" class="MCXref xref">[!DNL Gmail]を[!UICONTROL Workfront Fusion]</a>に接続する」を参照してください。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>メールの監視に使用するフィルタータイプを選択</p> 
    <ul> 
     ...
     <li> <p> <strong>[!UICONTROL Gmail filter]</strong> </p> <p>「[!UICONTROL Query]」フィールドに、メールのフィルタリングに使用するクエリを入力します。</p> <p>[!DNL Gmail]個のフィルターについて詳しくは、<a href="https://support.google.com/mail/answer/7190">のドキュメントの</a>検索の絞り込み[!DNL Gmail]を参照してください。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 1つのサイクル中にWorkfront Fusionが使用する結果の最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td>[!UICONTROL Connection] </td> 
   <td> <p>[!DNL Gmail] アカウントをWorkfront Fusionに接続する手順については、この記事の「<a href="#connect-gmail-to-workfront-fusion" class="MCXref xref">Workfront Fusion[!DNL Gmail]に</a>を接続する」を参照してください。</p> </td> 
  </tr> 
  <tr> 
