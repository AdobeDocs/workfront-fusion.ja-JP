...
[!DNL @gmail.com] または [!DNL @googlemail.com] ユーザーを使用する場合は、[!DNL Google Cloud Platform] で OAuth クライアントを作成し、[!UICONTROL Client ID] および [!UICONTROL Client Secret] を取得する必要があります。
