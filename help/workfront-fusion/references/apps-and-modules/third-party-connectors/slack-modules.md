...
description: Adobe Workfront Fusionでは、Slackを使用するワークフローを自動化したり、複数のサードパーティアプリケーションやサービスに接続したりできます。
author: Becky
...
Adobe Workfront Fusion のシナリオでは、[!DNL Slack] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
* [プライベートチャネルメッセージを取得](#get-a-private-channel-message)
* [パブリックチャネルメッセージの取得](#get-a-public-channel-message)
* [メッセージを更新](#update-a-message)
* [プライベートチャネルメッセージを見る](#watch-private-channel-messages)
* [パブリックチャネルメッセージを見る](#watch-public-channel-messages)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Slack] アカウントをWorkfront Fusionに接続する手順については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobe Workfront Fusionへの接続の作成 – 基本手順</a>を参照してください。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>このオプションを有効にすると、メッセージを、このモジュールの接続で使用される資格情報を所有するユーザーとして投稿します。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>メッセージに添付する各項目について、<b>項目を追加</b>をクリックし、項目の詳細を入力します。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL アイコン絵文字]</td> 
   <td>このメッセージのアイコンとして使用する絵文字を入力またはマッピングします（形式：<code>:icon-name:</code>）。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL アイコン URL]</td> 
   <td>このメッセージのアイコンとして使用する画像のURLを入力またはマッピングします。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>メッセージの投稿に使用するユーザー名を指定します。 ユーザー名が指定されていない場合は、「Bot」という名前が使用されます。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 削除するメッセージのタイムスタンプを入力またはマッピングします。</p> <p>注意：タイムスタンプは、Watch Private Channel Messages モジュールなどの別のモジュールを使用して取得できます。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL As user]</td> 
   <td> <p> このオプションを有効にすると、接続で使用される資格情報を持つユーザーとしてメッセージが削除されます。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 情報を取得するメッセージのメッセージタイムスタンプを入力またはマッピングします。</p> <p>注意：タイムスタンプは、[!UICONTROL Watch Private Channel Messages] モジュールなどの別のモジュールを使用して取得できます。</p> </td> 
  </tr> 
 </tbody> 
</table>

#### [!UICONTROL 公開チャネルメッセージを取得]**
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>更新するメッセージを含むチャネルのIDを入力またはマッピングします。</p> <p>メモ：チャネル ID は、[!UICONTROL List Channels] モジュールを使用して取得できます。</td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Message ID (Time stamp)]</p> </td> 
   <td> <p> 情報を取得するメッセージのメッセージタイムスタンプを入力またはマッピングします。</p> <p>注意：タイムスタンプは、[!UICONTROL Watch Public Channel Messages] モジュールなどの別のモジュールを使用して取得できます。</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>1回の実行サイクルでWorkfront Fusionが返すメッセージの最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [チャネル内のメンバーのリスト](#list-members-in-channel)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Limit] </td> 
   <td> <p>1回の実行サイクルでWorkfront Fusionが返すチャネルの最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
</table>
...
<tr> 
   ...
   <td> <p>必要なメッセージを選択する方法を選択します。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>「<strong>[!UICONTROL チャネル IDまたは名前]</strong>」フィールドに、ユーザーのリスト元となるチャネル IDまたはチャネルを入力するか、マッピングします。</p> <p>メモ：チャネル ID は、[!UICONTROL List Channels] モジュールを使用して取得できます。</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>チャネルのタイプを選択し、チャネルを選択します。</p> </li> 
    </ul> </td> 
  </tr>
  <tr> 
   <td role="rowheader">[!UICONTROL Limit] </td> 
   <td> <p>1回の実行サイクルでWorkfront Fusionが返すメンバーの最大数を設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
