 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>メッセージを作成するチャネルの選択方法を選択します。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p><strong>[!UICONTROL Channel ID or name]</strong> フィールドで、メッセージを投稿するチャネルのチャネル ID または名前を入力またはマッピングします。</p> <p>メモ：チャネル ID は [!UICONTROL List Channels] モジュールを使用して取得できます。</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>次の両方に該当する場合は、「<strong>[!UICONTROL Yes]</strong>」を選択します。</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>このオプションを有効にすると、自動解析を行うことができるようになります。 </p> <p>詳しくは、[!DNL Slack] ドキュメントの<a href="https://api.slack.com/docs/formatting">アプリケーションサーフェスのテキストの書式</a>を参照してください。</p> <p>メモ：元のメッセージで [!UICONTROL Link names] または [!UICONTROL Parse message text] のオプションを使用した場合は、[!UICONTROL Update a Message] モジュールを実行する際にも指定する必要があります。</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>必要なメッセージを選択する方法を選択します。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>「<strong>[!UICONTROL Channel ID or name]</strong>」フィールドで、チャネル ID またはメッセージを含むチャネルの <strong>[!UICONTROL Time Stamp (Message ID)]</strong> を入力またはマッピングしたあと、メッセージの ID を入力します。.</p> <p>メモ：チャネル ID は [!UICONTROL List Channels] モジュールを使用して取得できます。</p> </li> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Parse message text]</p> </td> 
   <td> <p>このオプションを有効にすると、自動解析を行うことができるようになります。 </p> <p> 詳しくは、[!DNL Slack] ドキュメントの<a href="https://api.slack.com/docs/formatting">アプリケーションサーフェスのテキストの書式</a>を参照してください。</p> <p>注意：元のメッセージで [!UICONTROL Link names] または [!UICONTROL Parse message text] のオプションを使用した場合は、「メッセージの更新」モジュールを実行するときにも指定する必要があります。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>「[!UICONTROL Yes]」を選択すると、結果からアーカイブ済みチャネルが除外されます。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Type] </td> 
...
このアクションモジュールでは、[!DNL Slack] API への認証済みのカスタム呼び出しを実行できます。これにより、他の [!DNL Slack] モジュールでは不可能なデータフロー自動処理を作成できます。
...
* **プライベートチャネル**：旧 [!UICONTROL Group]
* **ダイレクトメッセージ**：旧称 [!UICONTROL IM]
* **チャネル**:API ドキュメントの [!UICONTROL Conversation]、[!DNL Slack] アプリの [!UICONTROL channel]。
