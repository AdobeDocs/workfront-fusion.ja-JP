...
>[!NOTE]
>
>Workfront Fusionはデータソースではありません。 Workfront Fusionでは、データソースを作成および使用できますが、データは保存されません。
...
## Microsoft Power BI APIについて

Microsoft Power BI コネクタでは、次の機能が使用されます。
...
[!DNL Power BI] を設定すると、Workfront Fusion には以下のフィールドが表示されます。 これらと共に、アプリやサービスのアクセスレベルなどの要因に応じて、追加のフィールドが表示される場合があります。 モジュール内の太字のタイトルは、必須フィールドを示します。
...
* [ダッシュボードを入手](#get-a-dashboard)
* [ダッシュボードタイルを入手](#get-a-dashboard-tile)
* [リストダッシュボードタイル](#list-dashboard-tiles)
* [リストダッシュボード](#list-dashboards)
...
* [レポートを読む](#get-a-report)
* [レポートの一覧表示](#list-reports)
...
* [データセットを取得](#get-a-dataset)
* [データセットのリスト](#list-datasets)
* [データセットの更新](#refresh-a-dataset)
  ...
  <tbody>
   ...
   <td> <p>[!DNL Power BI] アカウントを Workfront Fusion に接続する手順について詳しくは、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobe Workfront Fusion への接続の作成 - 基本手順</a>を参照してください</p> </td> 
    ...
    <tr>
      ...
      <td>オプションを選択またはマッピングして、調整するテーブルを含むデータセットを選択します。</td>
    </tr>
    <tr>
...
* [アプリを入手](#get-an-app)
* [アプリのダッシュボードを取得](#get-an-apps-dashboard)
* [アプリのレポートを取得](#get-an-apps-report)
* [アプリのダッシュボードを一覧表示](#list-apps-dashboards)
* [アプリのレポートを一覧表示](#list-apps-reports)
* [アプリの一覧表示](#list-apps)
* [アプリを見る](#watch-apps)
  ...
  <tbody>
   ...
   <td> <p>[!DNL Power BI] アカウントを Workfront Fusion に接続する手順について詳しくは、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobe Workfront Fusion への接続の作成 - 基本手順</a>を参照してください</p> </td> 
    ...
    <tr>
      ...
      <td>
        <p><code>https://api.powerbi.com</code> からの相対パスを入力します。 例：<code>/v1.0/myorg/datasets</code>。</p>
      </td>
    </tr>
    <tr>
      <td role="rowheader">
