   ...
   <table style="table-layout:auto">
    ...
    <tbody> 
     <tr> 
      ...
      <td>新しい[!DNL DocuSign]接続の名前を入力してください。</td> 
     </tr> 
     <tr> 
      <td role="rowheader"> <p>[!UICONTROL Environment]</p> </td> 
      <td>実稼動環境以外の実稼動環境に接続するかどうかを選択します。</td> 
     </tr> 
     <tr> 
      <td role="rowheader"> <p>[!UICONTROL Connection name]</p> </td> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL DocuSign] アカウントをWorkfront Fusionに接続する方法については、この記事の「<a href="#connect-docusign-to-workfront-fusion" class="MCXref xref">DocusignをWorkfront Fusionに接続する</a>」を参照してください。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL Connection]</td> 
   <td> <p>[!DNL DocuSign] アカウントを Workfront Fusion に接続する手順について詳しくは、この記事の <a href="#connect-docusign-to-workfront-fusion" class="MCXref xref">[!DNL DocuSign] を Workfront Fusion に接続</a>を参照してください。</p> </td>
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Account] </td> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p>DocuSign アカウントをWorkfront Fusionに接続する手順については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref">接続の作成 – 基本手順</a>を参照してください。</p> </td> 
  </tr> 
  <tr data-mc-conditions="">
  ...
  <tr> 
   ...
   <td>受信者に送信されるメールの本文（コンテンツ）を入力するか、マッピングします。</td> 
  </tr> 
  <tr>
   ...
   <td> 受信者にプライベートメッセージを送信する場合は、メッセージのテキストを入力またはマッピングします。 <p>選択した受信者にのみ、一般メッセージと共にプライベートメッセージも表示されます。 プライベートメッセージの長さは 1000 文字までです。</p>  </td> 
  </tr> 
  <tr> 
...
<td> <p>DocuSign アカウントをWorkfront Fusionに接続する方法については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref">接続の作成 – 基本手順</a>の記事を参照してください。</p> </td> 
  </tr> 
  <tr> 
    <td role="rowheader">[!UICONTROL Account] </td>
  ...
  <tr> 
    ...
    <td>この封筒に追加する受信者ごとに、<b>項目を追加</b>をクリックし、次の詳細を入力します。
    <ul>
    <li><b>アクセスコード</b><p>受信者がエンベロープにアクセスするために使用するコードを入力またはマッピングします。<p></li>
    <li><b>メール</b><p>受信者の電子メールアドレスを入力またはマッピングします。<p></li>
    <li><b>名前</b><p>受信者の名前を入力またはマッピングします。<p></li>
    <li><b>役割名</b><p>受信者の役割名を入力またはマッピングします。<p></li>
    <li><b>ルーティング注文</b><p>受信者のルーティング番号を入力またはマッピングします。 ルーティング番号は、受信者がドキュメントを受け取り署名する順序を指定するものです。<p></li>
    </ul>
    </td>
    </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>受信者の再試行を許可するには、このオプションを有効にします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">
     [!UICONTROL Authoritative copy]
   </td> 
   <td> <p>このオプションを有効にすると、このエンベロープ内の文書が権威あるコピーとしてマークされます。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">
     [!UICONTROL自動ナビゲーション ]
  ...
  <tr> 
   ...
   <td> <p>ブランドのIDを入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">
     [!UICONTROL マークアップ有効]
   </td> 
   <td> <p>ドキュメントマークアップを有効にするには、このオプションを有効にします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">
     [!UICONTROL Expire Enabled]
   </td> 
   <td> <p>このエンベロープの有効期限を設定するには、このオプションを有効にします。 このオプションを有効にする場合は、次のフィールドに入力します。<ul><li><b>有効期限</b><p>このエンベロープの有効期限が切れるまでの日数を入力またはマッピングします。</p></li><li><b>期限切れの警告</b><p>リマインダーメールが受信者に送信される有効期限までの日数を入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">
     [!UICONTROL Body]
   </td> 
   <td> <p>この封筒に添付するメールの本文（コンテンツ）を入力するか、マッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">
     [!UICONTROL Subject]
   </td> 
   <td> <p>この封筒に添付するメールの件名を入力するか、マッピングします。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>リクエストのヘッダーを標準 JSON オブジェクトの形式で追加します。 これにより、リクエストのコンテンツタイプが決まります。</p> <p>例：<code> {"Content-type":"application/json"}</code></p> <p>メモ：エラーが表示され、エラーの発生元を特定するのが困難な場合は、Workfront ドキュメントに基づいてヘッダーの変更を考慮してください。 カスタム API 呼び出しで 422 HTTP リクエストエラーが返される場合は、"Content-Type":"text/plain"ヘッダーを使用してみてください。</p> </td> 
  </tr> 
  <tr> 
...
![Docusign セットアップの例](/help/workfront-fusion/references/apps-and-modules/assets/example-docusign-setup-350x770.png)

結果は、モジュールの出力（バンドル／本文／エンベロープの下）にあります。

この例では、6 個のエンベロープが返されました。

![docusign出力の例](/help/workfront-fusion/references/apps-and-modules/assets/docusign-example-output-350x677.png)
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>エンベロープ署名証明書をダウンロードに含めるには、このオプションを有効にします。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Documents by User ID]</td> 
   <td>受信者がユーザーIDでドキュメントを取得できるようにするには、このオプションを有効にします。 例えば、ユーザーが異なる表示の 2 つの異なるルーティングオーダーに含まれている場合、このオプションを使用すると、両方のルーティングのすべてのドキュメントが戻されます。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Encrypt]</td> 
   <td>このオプションを有効にすると、レスポンスで返されるPDF バイトが、自分の[!DNL DocuSign] アカウントで設定されているすべてのキーマネージャーに対して暗号化されます。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>このオプションを有効にすると、返されたPDFの変更されたフィールドが黄色で強調表示され、オプションの署名またはイニシャルが赤で表示されます。</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Envelope ID]</td> 
   <td> <p> 情報を読み取る文書を含むエンベロープのIDを入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
