...
Adobe Workfront Fusion のシナリオでは、[!DNL Microsoft Word Templates] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
Adobe Workfront Fusionで[!DNL Miscrosoft Word Templates]を使用するには、[!DNL Office 365] アカウントが必要です。 `www.office.com`に作成できます。



## Workfront Fusionへの[!DNL Office] サービスの接続
...
![Word テンプレート以前](/help/workfront-fusion/references/apps-and-modules/assets/word-template-before-filled-350x62.png)
...
単純な値タグは、対応する値に置き換えられるだけです。 タグの名前は、[!UICONTROL Key] フィールドの値と一致します。この値は、二重中括弧の中に配置されます（例：`{{name}}`）。
...
![Word テンプレート条件](/help/workfront-fusion/references/apps-and-modules/assets/word-template-conditional-350x501.png)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>置き換えるテキストの先頭をマークする文字を入力します。 </p> <p class="example" data-mc-autonum="<b>Example: </b>"><span class="autonumber"><span><b>例：</b></span></span>Enter <code>&#91;&#91;</code> to replace <code>[[replace_me]]</code>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL End delimiter of the text being replaced]</p> </td> 
   <td> <p>置き換えるテキストの末尾をマークする文字を入力します。 </p> <p class="example" data-mc-autonum="<b>Example: </b>"><span class="autonumber"><span><b>例：</b></span></span>Enter <code>&#93;&#93;</code> to replace <code>[[replace_me]]</code></p>. </td> 
  </tr> 
  <tr> 
