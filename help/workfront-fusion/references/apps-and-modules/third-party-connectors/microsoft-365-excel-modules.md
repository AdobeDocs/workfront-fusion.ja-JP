...
description: Adobe Workfront Fusionでは、Microsoft 365 Excelを使用するワークフローを自動化したり、複数のサードパーティ製アプリケーションやサービスに接続したりできます。
author: Becky
...
Adobe Workfront Fusion のシナリオでは、[!DNL Microsoft 365 Excel] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
## Microsoft Office 365 Excel APIについて

Microsoft Office 365 Excel コネクタでは、次の機能が使用されます。
...
## Workfront Fusionへの[!DNL Office 365 Excel] サービスの接続

[!DNL Office 365 Excel] アカウントを [!UICONTROL Workfront Fusion] に接続する方法について詳しくは、[[!UICONTROL Adobe Workfront Fusion] への接続の作成 - 基本手順](/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md)を参照してください。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Office 365] アカウントをWorkfront Fusionに接続する手順については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref">接続の作成 – 基本手順</a>を参照してください。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr>
   ...
   <td> <p>ワークブックがルートディレクトリにない場合のパスを含め、ワークシートを追加するワークブックを選択します。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
    <td role="rowheader" >[!UICONTROL Workbook] </td>
   <td> <p>ワークブックがルートディレクトリにない場合のパスを含め、行を追加するワークシートを含むワークブックを選択します。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr>
    <td role="rowheader" >[!UICONTROL Workbook] </td>
   <td> <p>リストする行を含むワークシートを含むワークブックを選択します。このワークブックがルートディレクトリにない場合のパスも含まれます。</p> </td> 
  </tr> 
  <tr> 
    <td role="rowheader" >[!UICONTROL Worksheet] </td>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr>
   ...
   <td> <p>このオプションを有効にすると、ワークシート内の空の行に対してバンドルが返されなくなります。</p> </td> 
  </tr> 
  <tr> 
    <td role="rowheader" >[!UICONTROL Limit]</td>
   <td> <p>各シナリオの実行サイクル中にモジュールが返すワークシート行の最大数を入力またはマッピングします。</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL テーブルを削除]</td> 
   <td> <p>削除するテーブルを識別する方法を選択します。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>削除するテーブルを含むワークブックのIDを入力またはマッピングしてから、テーブルを含むワークシートのIDを入力またはマッピングします。</p> <p>[!UICONTROL Table Name] フィールドに、削除するテーブルの名前を入力またはマッピングします。</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
     <p>Office 365 アカウントをWorkfront Fusionに接続する方法については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref">接続の作成 – 基本手順</a>を参照してください。</p>
     </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>取得するテーブルを識別する方法を選択します。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>取得するテーブルを含むワークブックのIDを入力またはマッピングしてから、テーブルを含むワークシートのIDを入力またはマッピングします。</p> <p>[!UICONTROL Table Name] フィールドに、取得するテーブルの名前を入力またはマッピングします。</p> </li> 
