...
description: Adobe Workfront Fusion [!DNL Google Docs] モジュールを使用すると、[!DNL Google Docs]および[!DNL Google Docs] （[!DNL Google Workspace] ユーザー向け）のドキュメントを監視、作成、編集、取得できます。
author: Becky
