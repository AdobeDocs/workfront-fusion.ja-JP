...
Workfront Fusionで[!DNL Google Slides]を使用するには、[!DNL Google] アカウントが必要です。 [!DNL Google] アカウントをまだお持ちでない場合は、[!DNL Google] アカウントのヘルプページで作成できます。
...
## Google Slides APIについて

Google スライドコネクタでは、次の機能が使用されます。
...
このアクションモジュールは、指定したプレゼンテーション上の既存のスライドを作成または削除します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Google Slides] アカウントをWorkfront Fusionに接続する手順については、<a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobe Workfront Fusionへの接続の作成 – 基本手順</a>を参照してください。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>スライドを削除する場合は、スライド IDを手動で入力するか、リストからスライドを選択するかを選択します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!DNL Presentation ID]</td> 
   <td> <p>スライドを追加または削除するプレゼンテーションのプレゼンテーション IDを選択するか、マッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!DNL Slide Object ID]</td> 
   <td> <p>スライドを削除する際に、スライドを手動で入力することを選択した場合は、スライド IDを入力するか、マッピングします。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>スライドのテキストコンテンツを入力またはマッピングします。 選択したテンプレートに基づいてフィールドを使用できます。</p> <p>このフィールドは、スライドを追加する場合に使用できます。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
このアクションモジュールは、プレゼンテーションをコピーし、`{{Name}}`、`{{Email}}`などのすべてのタグを指定されたデータに置き換えることで、新しいプレゼンテーションを作成します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> プレゼンテーションを選択するか、テンプレートとして使用するプレゼンテーションのプレゼンテーション IDを入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>次の値を追加します。</p> 
    <ul> 
     ...
     <li><strong>[!UICONTROL Replaced Value]</strong>：既存のタグを置き換える値を入力します。 例えば、プレゼンテーション内の文字列<code>&#123;&#123;Name&#125;&#125;</code>で、置換された値がSampleの場合、<code>&#123;&#123;Name&#125;&#125;</code>は<code>Sample</code>に置換されます。</li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL New Drive Location]</td> 
   <td> <p>新しいプレゼンテーションを保存または追加する[!DNL Google Drive]を選択します。</p> 
    <ul> 
     <li>[!UICONTROL My Drive]</li> 
     <li>[!UICONTROL Shared With Me]</li> 
     <li>[!UICONTROL [!DNL Google] Shared Drive]</li> 
  ...
  <tr> 
   ...
   <td> <p>プレゼンテーションを保存または追加するフォルダーを選択します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Shared] </td> 
   <td> <p>プレゼンテーションを共有するかどうかを選択します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Sharing with Other's Email Address]</td> 
   <td> <p> プレゼンテーションを共有する相手のメールアドレスを入力します。 このフィールドに電子メールを入力せずに「共有」オプションを有効にすると、プレゼンテーションは誰でも共有できます。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
このアクションモジュールは、指定されたページの最新バージョンまたはプレゼンテーション内のページのサムネールを取得します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL プレゼンテーションとページ IDを入力]</td> 
   <td> <p> プレゼンテーション IDとページ IDを手動で入力するか、リストから選択するかを選択します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Presentation ID]</td> 
...
このアクションモジュールは、指定したプレゼンテーションの最新バージョンを取得します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>1つのシナリオ実行サイクル中にモジュールが返すプレゼンテーションの最大数を入力またはマッピングします。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
このアクションモジュールは、IDで指定されたプレゼンテーションに格納されているチャートデータを更新します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> プレゼンテーション IDを手動で入力するか、リストから選択するかを選択します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Choose a drive]</td> 
   <td> <p>リストからプレゼンテーションを選択する場合は、リストするプレゼンテーションが配置されている[!DNL Google Drive]を選択します。</p> 
    <ul> 
     <li>[!UICONTROL My Drive]</li> 
     <li>[!UICONTROL Shared With Me]</li> 
     <li>[!UICONTROL [!DNL Google] Shared Drive]</li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Presentation ID]</td> 
   <td> <p>プレゼンテーションを選択するか、更新するグラフを含むプレゼンテーションのプレゼンテーション IDを入力またはマッピングします。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Chart Object ID]</td> 
   <td> <p> データを手動で入力する場合は、更新するグラフのIDを入力するか、マッピングします。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Choose a drive]</td> 
   <td> <p>ドロップダウンから選択する場合は、画像を追加するプレゼンテーションが配置されている[!DNL Google Drive]を選択します。</p> 
    <ul> 
     <li>[!UICONTROL My Drive]</li> 
     <li>[!UICONTROL Shared With Me]</li> 
     <li>[!UICONTROL [!DNL Google] Shared Drive]</li> 
  ...
  <tr> 
   ...
   <ul>
   <li><p><b>テキストタグを置換して画像をアップロード</b></p><p>「値」フィールドで、アップロードする画像ごとに<b>項目を追加</b>をクリックし、画像のタグと新しい画像のURLを入力します。</p></li>
   <li><p><b>画像を置換して画像をアップロード</b></p><p>「値」フィールドで、アップロードする画像ごとに<b>項目を追加</b>をクリックし、画像のオブジェクト ID、置換方法、新しい画像のURLを入力します。</p></li>
   </ul>
...
このトリガーモジュールは、新しいプレゼンテーションが作成または更新されたときにシナリオを開始します。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Limit]</td> 
   <td> <p>1回のシナリオ実行サイクルでWorkfront Fusionが返すプレゼンテーションの最大数を入力またはマッピングします。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>リンクを挿入する場合は、リンクを追加する各テキストアイテムについて、<b>項目を追加</b>をクリックし、テキストと関連するリンクを入力します。 アイテムがプレゼンテーションに表示されるたびに、指定したサイトに自動的にリンクされます。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p><code>https://developers.google.com/slides/</code> からの相対パスを入力します。 E.g. プレゼンテーション：</p> <p>使用可能なエンドポイントの一覧については、<a href="https://developers.google.com/slides/reference/rest">[!DNL Google Slides] API ドキュメント</a>を参照してください。</p> </td> 
  </tr> 
  <tr> 
...
![API呼び出しの例](/help/workfront-fusion/references/apps-and-modules/assets/api-call-350x13.png)
