---
title: Bynder モジュール
description: Adobe Workfront Fusion のシナリオでは、 [!DNL Bynder] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
author: Becky
...
Adobe Workfront Fusion のシナリオでは、[!DNL Bynder] を使用するワークフローを自動化したり、複数のサードパーティのアプリケーションやサービスに接続したりすることができます。
...
[!DNL Bynder] モジュール内から直接[!DNL Bynder] アカウントへのWorkfront Fusionの接続を作成できます。
...
>
>   * 米国クラスター：`https://app.workfrontfusion.com/oauth/cb/workfront-bynder`
...
このアクションモジュールは、1つ以上のアセットにタグを追加します
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>https://{your-bynder-domain}/api/{api-version}/</code> からの相対パスを入力します。</td> 
  </tr> 
  <tr> 
...
このアクションモジュールは、1つ以上のアセットからタグを削除します
  ...
  <tr> 
   ...
   <td> <p>検索条件を入力します。 </p> 
    <ul> 
     ...
     <li> <p><strong>[!UICONTROL Value]</strong> </p> <p>選択したフィールドに、検索する値を入力またはマッピングします。 値のタイプは、選択したフィールドのデータタイプと同じである必要があります。 </p> <p>データ型について詳しくは、<a href="/help/workfront-fusion/references/mapping-panel/data-types/item-data-types.md" class="MCXref xref">項目データ型</a>を参照してください。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
    ...
    <td>新しいアセットが作成されたときにシナリオを開始するか、既存のアセットが更新されたときに開始するかを選択します。</td>
  </tr> 
  <tr>
