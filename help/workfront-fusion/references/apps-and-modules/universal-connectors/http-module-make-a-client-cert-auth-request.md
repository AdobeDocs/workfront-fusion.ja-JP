...
# HTTP/[!UICONTROL Make a Client Certificate Authorization request] モジュール
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>クライアント証明書認証資格情報を含むキーを選択するか、[<strong>[!UICONTROL Add]</strong>] をクリックして資格情報を新しいキーに追加します。 </p> <p>メモ：接続を切り替えやすくするために、資格情報をさらに追加できます。</p> </td> 
  </tr> 
  <tr> 
