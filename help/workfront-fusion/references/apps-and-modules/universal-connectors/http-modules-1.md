---
title: HTTP モジュール
description: HTTP コネクタは、HTTP （Hypertext Transfer Protocol）プロトコルに基づいた様々な通信モジュールを提供します。 HTTP は、World Wide Web のためのデータ通信基盤です。 このモジュールを使用すると、web のページやファイルをダウンロードしたり、web フックや API エンドポイントを呼び出したりできます。
author: Becky
...
モジュールの適切な選択は、アクセスするリソースで使用される認証/承認メカニズムによって異なります。
