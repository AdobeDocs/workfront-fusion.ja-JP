...
description: Adobe Workfront Fusion テンプレート機能を使用すると、既存のテンプレートを作成し、Workfront Fusion シナリオのベースとして使用できます。
author: Becky
...
使用する前に、チームテンプレートを作成する必要があります。

公開テンプレートは、前提条件なしで利用できます。
...
1. シナリオをもう一度クリックして、シナリオの作成を開始します。
1. （条件付き）複数の組織のメンバーである場合は、シナリオを作成する組織を選択し、**続行**&#x200B;をクリックします。
1. （条件付き）複数のチームのメンバーである場合は、シナリオを作成するチームを選択し、**続行**&#x200B;をクリックします。
1. （条件付き）テンプレートがウィザードで設定されている場合は、プロンプトに従ってシナリオを設定します。 各プロンプトで「**続行**」をクリックして確定します。
