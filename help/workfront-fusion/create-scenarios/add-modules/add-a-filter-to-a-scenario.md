...
1. フィルター&#x200B;**[!UICONTROL 条件]**&#x200B;を定義します。
   ...
   最初のフィールド、演算子、および（必要に応じて）フィールドを比較する値でフィルタリングするフィールドを入力します。
...
既存のフィルターをコピーして、シナリオの別の場所にペーストできます。

1. 左側のパネルの「**[!UICONTROL シナリオ]**」タブをクリックします。
1. フィルターを追加するシナリオを選択します。
1. シナリオの任意の場所をクリックして、シナリオエディターに入ります。
1. フィルターが配置されているモジュール間の接続点を右クリックします。
1. 「**フィルターをコピー**」を選択します。
1. フィルターを貼り付けるモジュール間の接続点を右クリックします。
1. **貼り付け** フィルターを選択
1. （オプション）フィルターを調整するには、フィルターアイコンまたはラベルをクリックし、この記事の[2つのモジュール間にフィルターを追加](#add-a-filter-between-two-modules)の説明に従って値を入力します。
