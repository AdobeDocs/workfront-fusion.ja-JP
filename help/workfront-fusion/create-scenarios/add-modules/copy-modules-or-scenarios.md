...
description: Adobe Workfront Fusionでは、モジュール、モジュールのグループ、シナリオ全体をコピーできます。 この機能により、シナリオやシナリオの一部を再作成することなく、再利用できます。
author: Becky
...
Adobe Workfront Fusionでは、モジュール、モジュールのグループ、シナリオ全体をコピーできます。 この機能により、シナリオやシナリオの一部を再作成することなく、再利用できます。
...
* モジュールを別のチームまたは組織が所有するシナリオに貼り付ける場合、すべての接続を、新しいシナリオを所有するチームまたは組織が所有する接続に更新する必要があります。
