...
1. ルートの順序を確認するには、各ルートのラベルを確認します。 ルート 1 が最初に実行され、次にルート 2 が実行されます。
...
1. （任意）ルートを無効にするには、ルータからそのルートに通じるドットを右クリックし、「**ルートを無効にする**」を選択します。

   無効なルートには、ルータからルート上の最初のモジュールに向かう灰色のドットが表示され、ラベルには無効なルート アイコン ![&#x200B; 無効なルート アイコン &#x200B;](assets/disabled-route-icon.png) が表示されます。

1. （オプションと条件付き）無効なルートを有効にするには、ルートのラベルで無効なルートアイコン ![&#x200B; 無効なルートアイコン &#x200B;](assets/disabled-route-icon.png) をクリックします。
...
フィルターを持つルーターは、ルートラベルにフィルターアイコン ![&#x200B; フィルターアイコン &#x200B;](assets/fusion-scenario-filter-icon.png) を表示します。
...
1. （条件付き）フィルター名が長すぎてラベルに収まらない場合は、ラベルの上にマウスポインターを置いて、名前全体を表示します。
...
フォールバックルートには、ラベルに「フォールバック」と表示されます。
