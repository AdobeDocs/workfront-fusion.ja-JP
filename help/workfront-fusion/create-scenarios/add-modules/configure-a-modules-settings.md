...
例えば、Workfront/ドキュメントアップロードモジュールでは、ドキュメントをアップロードするレコードを指定する必要があります。
...
1. モジュールに必要な場合は、[接続の概要](/help/workfront-fusion/get-started-with-fusion/understand-fusion/connection-overview.md)の説明に従って、そのサービスの登録済みユーザーアカウントに&#x200B;**[!UICONTROL 接続]**&#x200B;を作成します。
