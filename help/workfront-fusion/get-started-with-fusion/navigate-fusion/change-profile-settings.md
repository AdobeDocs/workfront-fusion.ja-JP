---
title: プロファイル設定を変更
description: Adobe Workfront Fusion アカウントプロファイルで情報を変更できます。
author: Becky
...
Adobe Workfront Fusion アカウントプロファイルで情報を変更できます。
...
* **[!UICONTROL Workfront プロファイル]**&#x200B;にアクセスします。 プロファイルにアクセスしたら、**[!UICONTROL 詳細]** メニューをクリックし、**[!UICONTROL 編集]**&#x200B;を選択します。
