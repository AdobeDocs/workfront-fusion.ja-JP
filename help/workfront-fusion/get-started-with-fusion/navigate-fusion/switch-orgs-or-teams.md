...
複数の組織またはチームのメンバーである場合は、Fusionからログアウトせずに切り替えることができます。
...
チームを切り替えるには、ヘッダーのチーム名をクリックして新しいチームを選択し、ドロップダウンからチームを選択します。

このオプションは、左側のナビゲーション（組織の概要を除く）の項目（シナリオ ページや接続ページなど）をクリックして到達したすべてのページで使用できます。
