...
>
>     シナリオにメモを追加すると、シナリオエディターの下部にある **[!UICONTROL メモ]** アイコン ![ メモとドットの付いたメモアイコン ](assets/notes-icon-w-dot.png) にオレンジ色のドットが表示されます。
>
>1. **[!UICONTROL メモ]** アイコン ![ メモ アイコン（ドット付き ](assets/notes-icon-w-dot.png) をクリックして、メモを表示します。
>
