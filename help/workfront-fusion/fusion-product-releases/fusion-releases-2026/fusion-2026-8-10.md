...
基礎となる認証メカニズムについて詳しくは、[Event Subscription API](https://experienceleague.adobe.com/en/docs/workfront/using/adobe-workfront-api/event-subscriptions/event-subs-api)のドキュメントと、[Workfront](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/workfront-modules.md)または[Workfront Planning](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/workfront-planning-modules.md) コネクタのドキュメントを参照してください。
