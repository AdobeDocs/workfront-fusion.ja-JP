...
契約書への署名について詳しくは、「[Adobe Gen AI契約書に署名する](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview#sign-the-adobe-gen-ai-agreement)」を参照してください。詳しくは、Workfront ドキュメントのAI アシスタントの概要を参照してください。
