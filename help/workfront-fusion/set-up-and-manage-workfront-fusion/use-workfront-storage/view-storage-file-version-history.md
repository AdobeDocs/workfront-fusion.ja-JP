...
バージョンは新しい順に表示され、それぞれ次のように表示されます。
   ...
   * **ダウンロード** ボタン
   ...
   現在の（最新の）バージョンには、**&quot;current&quot;** バッジがラベル付けされています

特定のバージョンをダウンロードするには、「[特定のバージョンをダウンロードする](/help/workfront-fusion/set-up-and-manage-workfront-fusion/use-workfront-storage/download-files-from-storage.md#download-a-specific-version)」を参照してください。
