...
1. ダウンロードするファイルを含むリポジトリとフォルダーに移動します。
1. テーブルでファイルをクリックしてファイルを選択します。
1. 表示されるアクションバーで、**ダウンロード**&#x200B;をクリックします。
...
* ダウンロードの進行状況の割合
* 転送済みバイト数
* ダウンロードを中止する&#x200B;**キャンセル** ボタン

ファイルは、ブラウザーのデフォルトのダウンロード場所に保存されます。

## 特定のバージョンのファイルのダウンロード

1. Workfront Fusionで、左側のナビゲーションで「**ストレージ**」をクリックします。
1. ダウンロードするファイルを含むリポジトリとフォルダーに移動します。
1. ファイルを選択し、アクションバーの「**&quot;バージョン&quot;**」をクリックします。
1. **バージョン履歴** パネルで、ダウンロードするバージョンの横にある&#x200B;**ダウンロード**&#x200B;をクリックします。
