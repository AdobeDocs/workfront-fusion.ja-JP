...
* 操作の値は異なる場合があります。 いくつかは、より小さく、より単純な操作になり、他はより複雑になります。 操作は、単純なものから複雑なものまで、合計に対してカウントされます。
...
>[!NOTE]
>
>Workfront Fusion パッケージで許可されているよりも多くの操作を日常的に使用しようとする場合は、Ultimateの自動化と統合パッケージへのアップグレードを検討することをお勧めします。
